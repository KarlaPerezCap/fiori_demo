		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zns02zdemo02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zns02zdemo02-display": {
								"semanticObject": "zns02zdemo02",
								"action": "display",
								"description": "Demo Fiori Application with Northwind ODATA",
								"title": "Fiori Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zns02.zdemo02",
									"url": sap.ui.require.toUrl("zns02/zdemo02")
								}
							}
						}
					}
