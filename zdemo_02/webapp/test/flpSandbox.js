			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zns2zdemo02-display": {
								"semanticObject": "zns2zdemo02",
								"action": "display",
								"description": "Fiori prueba git",
								"title": "prueba github",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zns2.zdemo02",
									"url": sap.ui.require.toUrl("zns2/zdemo02")
								}
							}
						}
					}
